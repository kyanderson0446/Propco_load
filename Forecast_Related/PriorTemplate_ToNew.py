...
##############
# paths
path = fr"\\pgfs01\shared\PACS\Finance\Acquistions & New Build\Closing\2023 - HL Saddle-66\Proformas\Aug start date_Mar24Hist\*.xlsx"
map = '96linemap.xlsx'
...
for file in glob(path):
    ...
    # Save
    time.sleep(1)
    wb.save(fr"\\pgfs01\shared\PACS\Finance\Acquistions & New Build\Closing\2023 - HL Saddle-66\Proformas\Aug start date_Mar24Hist\Upload\{file_name}.xlsx")
    time.sleep(2)
    wb.close()
